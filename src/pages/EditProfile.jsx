  ...
  return (
    <div className='w-full h-full flex flex-col items-center'>
        ...
        <div className='w-fit p-12 flex flex-col gap-8 items-center justify-center'>
          <img src="/public/vite.svg" alt="" className='w-36 border-slate-200 border-2 p-6 shadow-sm rounded-full'/>
            <p className='text-black text-2xl'>Edit Profile</p>
            <div>
              <p className='text-black'>Username</p>
              <input type="text" ref={usernameVal} className='border-b px-2 h-10 text-black focus:outline-none' placeholder={username} />
            </div>
            <div>
              <p className='text-black'>Bio</p>
              <input type="text" ref={bioVal} className='border-b px-2 h-10 text-black focus:outline-none' placeholder={bio} />
            </div>
